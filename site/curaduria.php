...
<body>
    ...
    <div class="mt-3 flex gap-2 justify-center" style="background-color: #f4f4f4; padding: 30px;">
        <div class="item-cur">
            <h2 class="font-2">Château de Môtiers</h2>
            <p class="font-1">
                The place where BOVET's history
                began...
            </p>
        </div>
        <div class="item-cur">
            <h2 class="font-2">DIMIER 1738</h2>
            <p class="font-1">
        ...
        <div class="item-cur">
            <h2 class="font-2">BOVET</h2>
            <p class="font-1">
                Manufacture de Cadrans et de
                Sertissage
            </p>
        </div>
    </div>
